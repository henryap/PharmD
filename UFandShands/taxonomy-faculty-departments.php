      ...
      <article id="main-content" class="span-17" role="main">
        ...
        <?php if (have_posts()) : ?>			
          ...
          <?php /* If this is a tag archive */
            ...
            <h1 class="page-title medium-blue">Content Tagged <span class="light-blue">&ldquo;</span><strong class="dark-blue"><?php single_tag_title(); ?></strong><span class="light-blue">&rdquo;</span> <a title="Subscribe to <?php single_tag_title(); ?> RSS Feed" href="feed/"><img class="rss-icon" src="<?php bloginfo('template_directory'); ?>/images/rss.png" alt="Subscribe to RSS Feed" /></a></h1>
